      ...
      <div className={styles.createMissionContainer}>
        ...
        <div className={styles.createMissionBoxContent}>
          <FormControl isInvalid={isErrorName} isRequired>
            ...
            />
            {!isErrorName ? (
              <FormHelperText>Le nom de la mission</FormHelperText>
            ) : (
          ...
          <FormControl isInvalid={isErrorCategory} isRequired>
            ...
            {!isErrorCategory ? (
              <FormHelperText>La catégorie de la mission</FormHelperText>
            ) : (
              <FormErrorMessage>Requis</FormErrorMessage>
            )}
          </FormControl>
          <FormControl isInvalid={isErrorChild} isRequired>
            ...
            <Select
              id="who"
              placeholder="Selectionner un.e enfant"
            ...
            {!isErrorChild ? (
              <FormHelperText>L'enfant attribué.e à la mission</FormHelperText>
            ) : (
              <FormErrorMessage>Requis</FormErrorMessage>
            )}
          </FormControl>
          <FormControl isInvalid={isErrorDeadline} isRequired>
            ...
            />
            {!isErrorDeadline ? (
              <FormHelperText>La date limite de la mission</FormHelperText>
            ) : (
              <FormErrorMessage>Requis</FormErrorMessage>
            )}
          </FormControl>
          ...
          <Button onClick={createMission} className={styles.buttonCreate}>
            Envoyer
          </Button>
        </div>
      </div>
