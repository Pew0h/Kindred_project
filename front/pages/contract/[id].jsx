...
function Contract() {
    ...
    useEffect(() => {
        getFromServer('contracts').then((contractsList) => {
            ...
            setContract(contractsList.data.find((contract) =>
                contract.id === parseInt(contractId.toString())
            ));
        });
    }, [contractId]);
                ...
                <>
                    ...
                    <div className={styles.signContainer}>
                        <Text fontSize='md' className={styles.sign}
                              backgroundColor={contract.parentSignature ? "#48BB78 !important" : "#F56565 !important"}>
                            Signature parent
                        </Text>
                        <Text fontSize='md' className={styles.sign}
                              backgroundColor={contract.childSignature ? "#48BB78 !important" : "#F56565 !important"}>
                            Signature enfant
                        </Text>
                    </div>
                </>
