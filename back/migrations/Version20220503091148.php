 ...
 */
final class Version20220503091148 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE mission ADD CONSTRAINT FK_9067F23CDD62C21B FOREIGN KEY (child_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE mission ADD CONSTRAINT FK_9067F23C727ACA70 FOREIGN KEY (parent_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE mission ADD CONSTRAINT FK_9067F23C4459404E FOREIGN KEY (child_note_id) REFERENCES note (id)');
        $this->addSql('ALTER TABLE mission ADD CONSTRAINT FK_9067F23C54A57C13 FOREIGN KEY (parent_note_id) REFERENCES note (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE mission DROP FOREIGN KEY FK_9067F23CDD62C21B');
        $this->addSql('ALTER TABLE mission DROP FOREIGN KEY FK_9067F23C727ACA70');
